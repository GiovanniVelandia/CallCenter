...
public class CallCenter {
	...
	public synchronized Empleado obtenerEmpleado() {
		...
		// El proceso de atencion estaria atendido como primera instancia por un
		// operador
		...
		// Como segunda instancia estaria el supervisor de no existir libre
		// ningun operador
		...
		// Por ultima instancia se dara la atencio por el director de no estar
		// libre ningun operador o supervisor
